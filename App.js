...
export default class App extends React.Component {
  ...
  onTilePress = (row, col) => {
    ...
    // when tile is pressed, you check which player's turn it is and change the proper cell to that player's value
  ...
  getWinner = () => {
    ...
    // check the diagonal from top left, middle, bottom right...
    sum = cells[0][0] + cells[1][1] + cells[2][2];
    if (sum == 3) { return 1; }
    else if (sum == -3) { return -1; }

    // check the diagonal from top right, middle, bottom left...
